...
const Hys = () => {
  ...
  const icons = [
    ...
    { path: '/pagina4', icon: <AiOutlineSchedule fontSize={'50px'} />, name: 'Cronograma anual de \ncapacitaciones', disabled: 'disabled' },
    { path: '/pagina5', icon: <FaWpforms fontSize={'50px'} />, name: 'Planillas de \ncapacitacion', disabled: 'disabled' },
    { path: '/pagina6', icon: <AiOutlineAlert fontSize={'50px'} />, name: 'Plan de conteingencias', disabled: 'disabled' },
    { path: '/pagina7', icon: <GiSiren fontSize={'70px'} />, name: 'Simulacros de \nemergencia', disabled: 'disabled' },
    ...
    { path: '/pagina10', icon: <MdNoiseAware fontSize={'50px'} />, name: 'Medición de ruidos molestos \nal vecindario', disabled: 'disabled' },
    { path: '/pagina11', icon: <FcElectricity fontSize={'50px'} />, name: 'Medición de \npuesta a tierra', disabled: 'disabled' },
    { path: '/pagina12', icon: <GiBodyHeight fontSize={'50px'} />, name: 'Ergonomía de los \npuestos de trabajo', disabled: 'disabled' },
    { path: '/pagina13', icon: <BsFire fontSize={'50px'} />, name: 'Carga de fuego', disabled: 'disabled' },
    { path: '/pagina14', icon: <FaFireExtinguisher fontSize={'50px'} />, name: 'Control mensual \nde matafuegos', disabled: 'disabled' },
    ...
    { path: '/pagina16', icon: <HiOutlineDocumentReport fontSize={'50px'} />, name: 'Informe análisis de \nriesgos laborales', disabled: 'disabled' },
    { path: '/pagina17', icon: <GiFuelTank fontSize={'50px'} />, name: 'Certificación tanque \nde combustible', disabled: 'disabled' },
    ...
    { path: '/pagina22', icon: <TbVirusOff fontSize={'50px'} />, name: 'Protocolo y control \nCOVID-19 037', disabled: 'disabled' },
