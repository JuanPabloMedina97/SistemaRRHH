      ...
      const empleados = results.map((row) => {
        ...
        const empleado = {
          ...
          direccion: {
            ...
            barrio: barrio2,
            detalle: detalle2,
            entreCalles: entreCalles2,
            indicacionAdicional: indicacionAdicional2,
          },
          contacto: {
            numTelefono,
            numTelefono2,
            ...
            correo2,
            pariente: {
              nombre: nombrePariente,
              numero: numeroPariente,
            },
            pariente2: {
              nombre: nombrePariente2,
              numero: numeroPariente2,
            },
          },
          ...
          datosBancarios: {
            ...
            alias,
            medioDeCobro,
            direccion: direccionBancaria,
            direccionDos: direccionBancariaDos,
            direccionTres: direccionBancariaTres,
          },
          talleRopa: {
            pantalon,
            camisa,
